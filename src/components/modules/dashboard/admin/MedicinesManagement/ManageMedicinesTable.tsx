...
import AdminUpdateMedicine from "./AdminUpdateMedicine";
import AdminViewMedicine from "./AdminViewMedicine";
import { formatDate } from "@/lib/utils";
import Image from "next/image";

export default function ManageMedicinesTable({
  medicines,
  categories,
  meta,
}: {
              ...
              >
                ...
                <TableCell className="text-center">
                  <div className="flex justify-center items-center gap-2">
                    ...
                    />
                    <AdminViewMedicine medicine={medicine} />
                  </div>
                </TableCell>
              </TableRow>
            ))
